    ...
    >
      <section className="max-w-6xl mx-auto my-8 px-4">
        <div className="bg-white rounded-lg shadow-lg p-8">
          <h1 className="text-3xl font-bold mb-6 text-[#509f8c]">
          ...
          <p className="text-lg text-gray-700 font-bold mt-8 mb-4">
            {t("PrivacyPolicy.interpretationTitle")}
          </p>
          <p className="mb-6">{t("PrivacyPolicy.interpretationText")}</p>

          <p className="text-lg text-gray-700 font-bold mt-8 mb-4">
            {t("PrivacyPolicy.definitionsTitle")}
          </p>
          ...
          <div className="space-y-4 mb-6">
            <div className="ml-4">
              <p>
                {t("PrivacyPolicy.accountDefTitle")}{" "}
                {t("PrivacyPolicy.accountDefText")}
              </p>
            </div>
            <div className="ml-4">
              <p>
                {t("PrivacyPolicy.affiliateDefTitle")}{" "}
                {t("PrivacyPolicy.affiliateDefText")}
              </p>
            </div>
            <div className="ml-4">
              <p>
                {t("PrivacyPolicy.companyDefTitle")}{" "}
                {t("PrivacyPolicy.companyDefText")}
              </p>
            </div>
            <div className="ml-4">
              <p>
                {t("PrivacyPolicy.cookiesDefTitle")}{" "}
                {t("PrivacyPolicy.cookiesDefText")}
              </p>
            </div>
            <div className="ml-4">
              <p>
                {t("PrivacyPolicy.countryDefTitle")}{" "}
                {t("PrivacyPolicy.countryDefText")}
              </p>
            </div>
            <div className="ml-4">
              <p>
                {t("PrivacyPolicy.deviceDefTitle")}{" "}
                {t("PrivacyPolicy.deviceDefText")}
              </p>
            </div>

            <p className="text-lg text-gray-700 font-bold mt-8 mb-4">
              {t("PrivacyPolicy.personalDataDefText")}
            </p>

            <div className="ml-4">
              <p>
                {t("PrivacyPolicy.serviceDefTitle")}{" "}
                {t("PrivacyPolicy.serviceDefText")}
              </p>
            </div>
            <div className="ml-4">
              <p>
                {t("PrivacyPolicy.serviceProviderDefTitle")}{" "}
                {t("PrivacyPolicy.serviceProviderDefText")}
              </p>
            </div>
            <div className="ml-4">
              <p>
                {t("PrivacyPolicy.usageDataDefTitle")}{" "}
                {t("PrivacyPolicy.usageDataDefText")}
              </p>
            </div>
            <div className="ml-4">
              <p>
                {t("PrivacyPolicy.websiteDefTitle")}{" "}
                {t("PrivacyPolicy.websiteDefText")}
              </p>
            </div>

            <p className="text-lg text-gray-700 font-bold mt-8 mb-4">
              {t("PrivacyPolicy.youDefTitle")}
            </p>
          ...
          <p className="text-lg text-gray-700 font-bold mt-8 mb-4">
            {t("PrivacyPolicy.personalDataUsage")}
          </p>
          ...
          <p className="text-lg text-gray-700 font-bold mt-8 mb-4">
            {t("PrivacyPolicy.trackingTitle")}
          </p>
          <p className="mb-4">{t("PrivacyPolicy.trackingText")}</p>

          <p className="text-lg text-gray-700 font-bold mt-8 mb-4">
            {t("PrivacyPolicy.trackingCookiesTitle")}
          </p>
          <p className="mb-4">{t("PrivacyPolicy.trackingCookiesText")}</p>

          <p className="text-lg text-gray-700 font-bold mt-8 mb-4">
            {t("PrivacyPolicy.trackingBeaconsTitle")}
          </p>
          ...
          <p className="text-lg text-gray-700 font-bold mt-12 mb-8">
            {t("PrivacyPolicy.cookiesTypesText")}
          </p>
          <div className="space-y-6 mb-8">
            <div>
              <p className="text-base font-bold text-gray-700">
                {t("PrivacyPolicy.cookiesNecessaryTitle")}
              </p>
              <p className="font-bold">
                {t("PrivacyPolicy.cookiesNecessaryType")}
              </p>
            ...
            <div>
              <p className="text-base font-bold text-gray-700">
                {t("PrivacyPolicy.cookiesAcceptanceTitle")}
              </p>
            ...
            <div>
              <p className="text-base font-bold text-gray-700">
                {t("PrivacyPolicy.cookiesFunctionalityTitle")}
              </p>
          ...
          <ul className="list-disc ml-8 mb-8">
            ...
            <li>
              ...
              <a
                href="https://www.oasisnacoes.org/#contact"
                className="text-blue-600 hover:underline"
              >
                oasisnacoes.org/#contact
              </a>
            </li>
          </ul>
        </div>
